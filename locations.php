...
<head>
	...
	<title>Locations - O'Neill Healthcare &amp; Managment</title>
		...
		<div class="row centered">
			...
			<article class="col-md-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">O'Neill Healthcare Locations</h1>
				</header>
				...
				<img src="assets/images/map.jpg" alt="O'Neill Healthcare Locations Map">
